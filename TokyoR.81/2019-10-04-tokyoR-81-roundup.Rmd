...
Another important component of the asynchronous framework in R is the {promises} package. It's this package that allows for the actual abstractions within your R code for asynchronous programming such as the "promise pipe".
