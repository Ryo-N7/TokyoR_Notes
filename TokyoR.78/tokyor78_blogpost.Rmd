...
Key takeways and WINS:

- Reduce time at work by using the tidyverse to clean data
- Not have to open up extraordinarily large Excel files (as much as before...)
- Using `ggplot2` and `DiagrammeR` for informative output
- Start with descriptive statistics, nobody knows linear regression here...
