...
Just recently [TJ Mahr](), one of the authors of `bayesplot`, presented on the package at Chicago SatRDays. You can check out the slides out [here](https://www.tjmahr.com/bayesplot-satrdays-2019). The new version of `bayesplot`, 1.7.0, will also support tidyselect:
