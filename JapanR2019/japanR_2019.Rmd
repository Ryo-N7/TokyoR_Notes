...
This _________  was the __10th JapanR Conference__ hosted at [DeNA Corporation](https://dena.com/intl/company/overview.html) in Tokyo, Japan! 

This is another great opportunity to learn about R and its wide variety of uses by Japanese practitioners and academics. Besides the near-monthly meetup of [TokyoR](https://tokyor.connpass.com/) there are smaller gatherings spread throughout Japan such as [FukuokaR](https://fukuoka-r.connpass.com/) and [TsukubaR](https://tsukubar.org/) but the meeting that gathers the biggest crowd is the [JapanR Conference](http://japanr.net/) held every December since 2010. 
